...
var listePNJ : Array[String] = ["Nedy", "Mot"]
...
func _creer_liste_objets_base() -> Array[ObjetInventaire]:
	return [
		ObjetInventaire.new(Objet.new("Godoball", load("res://Assets/Objets/Godoballs/Pokeball attraper57.png") , "Cette Objet sert à capturer des Godomons", true, false, false, "0%"), 10),
